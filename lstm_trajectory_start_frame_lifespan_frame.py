...
with open( './lstm/lstm_traj_sf_lf_cv_train_loss.json', 'w') as f:
   json.dump(cv_train_loss, f)
with open( './lstm/lstm_traj_sf_lf_cv_val_loss.json', 'w') as f:
   json.dump(cv_val_loss, f)
with open( './lstm/lstm_traj_sf_lf_cv_train_accuracy.json', 'w') as f:
   json.dump(cv_train_accuracy, f)
with open( './lstm/lstm_traj_sf_lf_cv_val_accuracy.json', 'w') as f:
   json.dump(cv_val_accuracy, f)
with open( './lstm/lstm_traj_sf_lf_cv_test_accuracy.json', 'w') as f:
...
with open( './lstm/lstm_traj_sf_lf_test_train_loss.json', 'w') as f:
   json.dump(lstm_train_loss, f)
with open( './lstm/lstm_traj_sf_lf_test_train_accuracy.json', 'w') as f:
   json.dump(lstm_train_accuracy, f)
with open( './lstm/lstm_traj_sf_lf_test_test_accuracy.json', 'w') as f:
