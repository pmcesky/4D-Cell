...
class RNN(nn.Module):
    def __init__(self, output_size = 334):
        super().__init__()
        ...
        # Hidden layer
        self.rnn = nn.GRU(3, 3, num_layers=2, batch_first=True) # (x,y,z)
        # final Output layer
...
#             test_accuracy.append(acc_test)
#             print(f'Test_accuracy: {acc_test:.4f}')
#             torch.save(model.state_dict(), f"./rnn/model_pt/rnn_trajectory_{i}_fold_CV_{epoch}.pt") 
#     # Test
#     acc_test, _ = _utilities.evaluate_rnn(model, test_dl, optimizer, device)
#     # test_accuracy.append(acc_test)
#     print(f'Final Test_accuracy: {acc_test:.4f}')
...
# with open( './rnn/cv_train_loss_trajectory.json', 'w') as f:
#    json.dump(cv_train_loss, f)
# with open( './rnn/cv_val_loss_trajectory.json', 'w') as f:
#    json.dump(cv_val_loss, f)
# with open( './rnn/cv_train_accuracy_trajectory.json', 'w') as f:
#    json.dump(cv_train_accuracy, f)
# with open( './rnn/cv_val_accuracy_trajectory.json', 'w') as f:
#    json.dump(cv_val_accuracy, f)
# with open( './rnn/cv_test_accuracy_trajectory.json', 'w') as f:
#    json.dump(cv_test_accuracy, f)

# ################################ Train on all cross_validation dataset and test on test set with trajectory only features
# rnn_train_loss = []
# rnn_train_accuracy = []
# rnn_test_accuracy = []
# # train and test data
...
#         rnn_test_accuracy.append(acc_test)
#         print(f'Test_accuracy: {acc_test:.4f}')
#         torch.save(model.state_dict(), f"./rnn/model_pt/rnn_trajectory_{epoch}.pt") 
# # Test
# acc_test, _ = _utilities.evaluate_rnn(model, test_dl, optimizer, device)
# # test_accuracy.append(acc_test)
# print(f'Final Test_accuracy: {acc_test:.4f}')

# with open( './rnn/rnn_trajectory_train_loss.json', 'w') as f:
#    json.dump(rnn_train_loss, f)
# with open( './rnn/rnn_trajectory_train_accuracy.json', 'w') as f:
#    json.dump(rnn_train_accuracy, f)
# with open( './rnn/rnn_trajectory_test_accuracy.json', 'w') as f:
#    json.dump(rnn_test_accuracy, f)
...
#             test_accuracy.append(acc_test)
#             print(f'Test_accuracy: {acc_test:.4f}')
#             torch.save(model.state_dict(), f"./rnn/model_pt/rnn_trajectory_start_frame_lifespan_frame_{i}_fold_CV_{epoch}.pt") 
#     # Test
#     acc_test, _ = _utilities.evaluate_rnn(model, test_dl, optimizer, device)
#     # test_accuracy.append(acc_test)
#     print(f'Final Test_accuracy: {acc_test:.4f}')
...
# with open( './rnn/cv_train_loss_trajectory_start_frame_lifespan_frame.json', 'w') as f:
#    json.dump(cv_train_loss, f)
# with open( './rnn/cv_val_loss_trajectory_start_frame_lifespan_frame.json', 'w') as f:
#    json.dump(cv_val_loss, f)
# with open( './rnn/cv_train_accuracy_trajectory_start_frame_lifespan_frame.json', 'w') as f:
#    json.dump(cv_train_accuracy, f)
# with open( './rnn/cv_val_accuracy_trajectory_start_frame_lifespan_frame.json', 'w') as f:
#    json.dump(cv_val_accuracy, f)
# with open( './rnn/cv_test_accuracy_trajectory_start_frame_lifespan_frame.json', 'w') as f:
#    json.dump(cv_test_accuracy, f)

# ################################ Train on all cross_validation dataset and test on test set with trajectory, start_frame and lifespan features
# rnn_train_loss = []
# rnn_train_accuracy = []
# rnn_test_accuracy = []
# # train and test data
...
# # Trajectory, start_frame and lifespan features
# X_train = X_train[:,:152]
# X_test = X_test[:,:152]
...
#         rnn_test_accuracy.append(acc_test)
#         print(f'Test_accuracy: {acc_test:.4f}')
#         torch.save(model.state_dict(), f"./rnn/model_pt/rnn_trajectory_start_frame_lifespan_frame_{epoch}.pt") 
# # Test
# acc_test, _ = _utilities.evaluate_rnn(model, test_dl, optimizer, device)
# # test_accuracy.append(acc_test)
# print(f'Final Test_accuracy: {acc_test:.4f}')

# with open( './rnn/rnn_trajectory_start_frame_lifespan_frame_train_loss.json', 'w') as f:
#    json.dump(rnn_train_loss, f)
# with open( './rnn/rnn_trajectory_start_frame_lifespan_frame_train_accuracy.json', 'w') as f:
#    json.dump(rnn_train_accuracy, f)
# with open( './rnn/rnn_trajectory_start_frame_lifespan_frame_test_accuracy.json', 'w') as f:
#    json.dump(rnn_test_accuracy, f)



# ########################################## rnn use only trajectory + start_frame + lifespan_frame + division_orientation_to_mother_cell ###########################################################################################
# cv_train_loss = []
# cv_train_accuracy = []
# cv_val_loss = []
# cv_val_accuracy = []
...
#     # Trajectory + start_frame + lifespan_frame features + division_orientation_to_mother_cell
#     X_train = X_train[:,:155]
#     X_val = X_val[:,:155]
#     X_test = X_test[:,:155]
...
#             test_accuracy.append(acc_test)
#             print(f'Test_accuracy: {acc_test:.4f}')
#             torch.save(model.state_dict(), f"./rnn/model_pt/rnn_trajectory_start_frame_lifespan_frame_and_division_orientation_to_mother_cell_{i}_fold_CV_{epoch}.pt") 
#     # Test
#     acc_test, _ = _utilities.evaluate_rnn(model, test_dl, optimizer, device)
#     # test_accuracy.append(acc_test)
#     print(f'Final Test_accuracy: {acc_test:.4f}')
...
# with open( './rnn/cv_train_loss_trajectory_start_frame_lifespan_frame_and_division_orientation_to_mother_cell.json', 'w') as f:
#    json.dump(cv_train_loss, f)
# with open( './rnn/cv_val_loss_trajectory_start_frame_lifespan_frame_and_division_orientation_to_mother_cell.json', 'w') as f:
#    json.dump(cv_val_loss, f)
# with open( './rnn/cv_train_accuracy_trajectory_start_frame_lifespan_frame_and_division_orientation_to_mother_cell.json', 'w') as f:
#    json.dump(cv_train_accuracy, f)
# with open( './rnn/cv_val_accuracy_trajectory_start_frame_lifespan_frame_and_division_orientation_to_mother_cell.json', 'w') as f:
#    json.dump(cv_val_accuracy, f)
# with open( './rnn/cv_test_accuracy_trajectory_start_frame_lifespan_frame_and_division_orientation_to_mother_cell.json', 'w') as f:
#    json.dump(cv_test_accuracy, f)


# ################################ Train on all cross_validation dataset and test on test set with trajectory, start_frame, lifespan and division_orientation_to_mother_cell features
# rnn_train_loss = []
# rnn_train_accuracy = []
# rnn_test_accuracy = []
# # train and test data
...
#         rnn_test_accuracy.append(acc_test)
#         print(f'Test_accuracy: {acc_test:.4f}')
#         torch.save(model.state_dict(), f"./rnn/model_pt/rnn_trajectory_start_frame_lifespan_frame_and_division_orientation_to_mother_cell_{epoch}.pt") 
# # Test
# acc_test, _ = _utilities.evaluate_rnn(model, test_dl, optimizer, device)
# # test_accuracy.append(acc_test)
# print(f'Final Test_accuracy: {acc_test:.4f}')

# with open( './rnn/rnn_trajectory_start_frame_lifespan_frame_and_division_orientation_to_mother_cell_train_loss.json', 'w') as f:
#    json.dump(rnn_train_loss, f)
# with open( './rnn/rnn_trajectory_start_frame_lifespan_frame_and_division_orientation_to_mother_cell_train_accuracy.json', 'w') as f:
#    json.dump(rnn_train_accuracy, f)
# with open( './rnn/rnn_trajectory_start_frame_lifespan_frame_and_division_orientation_to_mother_cell_test_accuracy.json', 'w') as f:
#    json.dump(rnn_test_accuracy, f)